# [Financial Calculator](https://creativetimofficial.github.io/financial-calculator) [![version][version-badge]][CHANGELOG] [![license][license-badge]][LICENSE]

![alt text](https://s3.amazonaws.com/creativetim_bucket/products/85/original/opt_nud_angular_thumbnail.jpg)

**[Financial Calculator](https://creativetimofficial.github.io/financial-calculator)** is a responsive Bootstrap 4 kit provided for free by [Invision](https://www.invisionapp.com/) and [NeoAppStack](https://www.neoappstack.com/). It combines colors that are easy on the eye, spacious cards, beautiful typography, and graphics. Now UI Dashboard comes packed with all plugins that you might need inside a project and documentation on how to get started. It is light and easy to use, and also very powerful.
...
+ [Live Preview](https://creativetimofficial.github.io/financial-calculator)

**Tutorial**
In order for you to easily be able to use the Financial Calculator, we have created a tutorial page in our documentation. It shows the structure for the files inside the archive and how to import them. It then features every components with a description and example how to use it. You can see the details [here](https://creativetimofficial.github.io/financial-calculator/documentation/tutorial).
...
More products from NeoAppStack: <http://www.neoappstack.com/bootstrap-themes>

Tutorials: <https://www.youtube.com/channel/UCVyTG4sCw-rOvB9oHkzZD1w>

Freebies: <http://www.neoappstack.com/products>

Affiliate Program (earn money): <http://www.neoappstack.com/affiliates/new>
