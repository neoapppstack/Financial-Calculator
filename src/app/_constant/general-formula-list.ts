...
export const GeneralFormulaList: FormulaData[] = [
  {
    ...
    url: '/pages/general-formulas/future-value-of-annuity',
    other: 'Other data',
  ...
  },
  {
    ...
    description: `The future value (FV) of an annuity with continuous compounding formula is
     used to calculate the ending balance on a series of periodic payments that are compounded
      continuously`,
    url: `/pages/general-formulas/future-value-of-annuity-continuous-compounding`,
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/number-of-periods-of-annuity-from-future-value',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    amortized loan.`,
    url: '/pages/general-formulas/annuity_payment_formula',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/annuity-payment-from-future-value',
  ...
  },
  {
    ...
    url: '/pages/general-formulas/number-of-periods-of-annuity-from-present-value',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/present_value_of_annuity',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/average-collection-period',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    dollar cash flows`,
    url: '/pages/general-formulas/present-value-annuity-factor',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: 'pages/general-formulas/present_value_of_annuity_due',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/future-value-of-annuity-due',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/annuity-due-payment-fv',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/annuity-due-payment-pv',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/doubling-time',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    the rate of return.`,
    url: '/pages/general-formulas/doubling-time-continuous-compounding',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/doubling-time-simple-interest',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/future-value',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/future-value-continuous-compounding',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/future-value-factor',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/future-value-of-growing-annuity',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/growing-annuity-payment',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/growing-annuity-payment-from-future-value',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/present-value-of-growing-annuity',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/present-value-of-growing-perpetuity',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/solve-for-number-of-periods-pv-and-fv',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/perpetuity',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/present_value',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/present-value-continuous-compounding',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/present-value-factor',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    an investment`,
    url: '/pages/general-formulas/rule-of-72',
    other: 'Other data',
    iconName: 'mdi-calculator'
  },
  {
    ...
    url: '/pages/general-formulas/weighted_average',
    other: 'Other data',
    iconName: 'mdi-calculator'
  }
];
